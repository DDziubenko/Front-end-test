    ...
    >
      <div class="flex flex-col gap-[44px] lg:h-auto">
        ...
        >
          ...
          <div
            class="flex xl:mt-auto flex-wrap gap-8 items-end relative shrink-0 w-full xl:w-auto mt-8 max-w-full"
          >
            <!-- Image 1 -->
            <div class="h-[208px] w-[402px] relative shrink-0 block">
              <NuxtImg
                src="/images/sidebar/sidebar-5.webp"
                sizes="402px"
            ...
            <div class="h-[303px] w-[314px] relative shrink-0 block">
              <NuxtImg
                src="/images/sidebar/sidebar-6.webp"
                sizes="314px"
            ...
            <div class="h-[173px] w-[141px] relative shrink-0 block">
              <NuxtImg
                src="/images/sidebar/sidebar-7.webp"
                sizes="141px"
...
const logoBlack = "/icons/logo-black.svg"
const riCross = "/icons/ri_cross.svg"

const { isOpen, close } = useSidebar('booking')
...
const handleKeydown = (e: KeyboardEvent) => {
  if (!isOpen.value || !sidebarRef.value) return
